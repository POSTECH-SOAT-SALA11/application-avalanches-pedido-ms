...
public interface PedidoUseCaseInterface {
    Integer cadastrar(Pedido pedido, PedidoGatewayInterface pedidoGateway, ProdutoGatewayInterface produtoGateway, PagamentoGatewayInterface pagamentoGateway);
